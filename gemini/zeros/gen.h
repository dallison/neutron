...
class Generator : public gemini::Generator {
 public:
 ...
 private:
  ...
  absl::Status GenerateFieldInitializers(const Message& msg, std::ostream& os,
                                         const char* sep = " : ");
  absl::Status GenerateDefaultConstructor(const Message& msg, std::ostream& os);
  absl::Status GenerateEmbeddedConstructor(const Message& msg,
                                           std::ostream& os);
  absl::Status GenerateNonEmbeddedConstructor(const Message& msg,
                                              std::ostream& os);
