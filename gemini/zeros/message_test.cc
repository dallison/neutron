...
struct InnerMessage : public Message {
  InnerMessage()
      : str(offsetof(InnerMessage, str), 0),
        f(offsetof(InnerMessage, f),
          gemini::zeros::AlignedOffset<uint64_t>(str.BinaryEndOffset())) {}
  ...
  gemini::zeros::StringField str;
  gemini::zeros::Uint64Field f;
};
...
struct TestMessage : public Message {
  TestMessage(std::shared_ptr<toolbelt::PayloadBuffer *> buffer, toolbelt::BufferOffset offset)
      : Message(buffer, offset),
        ...
        y(offsetof(TestMessage, y),
          gemini::zeros::AlignedOffset<uint64_t>(x.BinaryEndOffset())),
        s(offsetof(TestMessage, s),
          gemini::zeros::AlignedOffset<toolbelt::StringHeader>(y.BinaryEndOffset())),
        m(buffer, offsetof(TestMessage, m),
          gemini::zeros::AlignedOffset<uint64_t>(s.BinaryEndOffset())),
        arr(offsetof(TestMessage, arr),
            gemini::zeros::AlignedOffset<uint32_t>(m.BinaryEndOffset())),
        vec(offsetof(TestMessage, vec),
            gemini::zeros::AlignedOffset<uint32_t>(arr.BinaryEndOffset())),
        marr(offsetof(TestMessage, marr),
             gemini::zeros::AlignedOffset<uint32_t>(vec.BinaryEndOffset())),
        sarr(offsetof(TestMessage, sarr),
             gemini::zeros::AlignedOffset<uint32_t>(marr.BinaryEndOffset())),
        mvec(offsetof(TestMessage, mvec),
             gemini::zeros::AlignedOffset<uint32_t>(sarr.BinaryEndOffset())),
        svec(offsetof(TestMessage, svec),
             gemini::zeros::AlignedOffset<uint32_t>(mvec.BinaryEndOffset())),
        e(offsetof(TestMessage, e),
          gemini::zeros::AlignedOffset<uint32_t>(svec.BinaryEndOffset())),
        earr(offsetof(TestMessage, earr),
             gemini::zeros::AlignedOffset<uint32_t>(e.BinaryEndOffset())),
        evec(offsetof(TestMessage, evec),
             gemini::zeros::AlignedOffset<uint32_t>(earr.BinaryEndOffset())),
        carr(offsetof(TestMessage, carr),
             gemini::zeros::AlignedOffset<int8_t>(evec.BinaryEndOffset())),
        cvec(offsetof(TestMessage, cvec),
             gemini::zeros::AlignedOffset<uint32_t>(carr.BinaryEndOffset())) {}
  static constexpr size_t BinarySize() {
    size_t offset = 0;  // x
    offset =
        gemini::zeros::AlignedOffset<uint64_t>(offset + sizeof(uint32_t));  // y
    offset =
        gemini::zeros::AlignedOffset<uint32_t>(offset + sizeof(uint64_t));  // s
    offset = gemini::zeros::AlignedOffset<uint64_t>(offset +
                                                    sizeof(toolbelt::StringHeader));  // m
    offset = gemini::zeros::AlignedOffset<uint32_t>(
        offset + InnerMessage::BinarySize());  // arr
    offset = gemini::zeros::AlignedOffset<uint32_t>(offset + sizeof(uint32_t) *
                                                                 10);  // vec
    offset = gemini::zeros::AlignedOffset<uint32_t>(
    ...
    offset = gemini::zeros::AlignedOffset<uint32_t>(offset +
                                                    sizeof(toolbelt::VectorHeader));  // e
    offset = gemini::zeros::AlignedOffset<uint32_t>(offset +
                                                    sizeof(uint32_t));  // earr
    offset = gemini::zeros::AlignedOffset<toolbelt::VectorHeader>(
        offset + sizeof(uint16_t) * 10);  // evec

    offset = gemini::zeros::AlignedOffset<int8_t>(
        offset + sizeof(toolbelt::VectorHeader));  // carr

    offset = gemini::zeros::AlignedOffset<int8_t>(offset +
                                                  sizeof(int8_t) * 32);  // cvec

    offset = gemini::zeros::AlignedOffset<uint16_t>(
  ...
  gemini::zeros::Uint32Field x;
  gemini::zeros::Uint64Field y;
  gemini::zeros::StringField s;
  gemini::zeros::MessageField<InnerMessage> m;
  gemini::zeros::PrimitiveArrayField<int32_t, 10> arr;
  gemini::zeros::PrimitiveVectorField<int32_t> vec;
  gemini::zeros::MessageArrayField<InnerMessage, 5> marr;
  gemini::zeros::StringArrayField<20> sarr;
  gemini::zeros::MessageVectorField<InnerMessage> mvec;
  gemini::zeros::StringVectorField svec;
  gemini::zeros::EnumField<EnumTest> e;
  gemini::zeros::EnumArrayField<EnumTest, 10> earr;
  gemini::zeros::EnumVectorField<EnumTest> evec;
  gemini::zeros::PrimitiveArrayField<int8_t, 32> carr;
  gemini::zeros::PrimitiveVectorField<int8_t> cvec;
};
