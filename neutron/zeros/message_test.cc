...
using Message = neutron::zeros::Message;
...
struct InnerMessage : public Message {
  ...
  neutron::zeros::StringField str;
  neutron::zeros::Uint64Field f;
};
...
struct TestMessage : public Message {
  TestMessage(std::shared_ptr<toolbelt::PayloadBuffer *> buffer, toolbelt::BufferOffset offset)
      : Message(buffer, offset),
        ...
        y(offsetof(TestMessage, y),
          neutron::zeros::AlignedOffset<uint64_t>(x.BinaryEndOffset())),
        s(offsetof(TestMessage, s),
          neutron::zeros::AlignedOffset<toolbelt::StringHeader>(y.BinaryEndOffset())),
        m(buffer, offsetof(TestMessage, m),
          neutron::zeros::AlignedOffset<uint64_t>(s.BinaryEndOffset())),
        arr(offsetof(TestMessage, arr),
            neutron::zeros::AlignedOffset<uint32_t>(m.BinaryEndOffset())),
        vec(offsetof(TestMessage, vec),
            neutron::zeros::AlignedOffset<uint32_t>(arr.BinaryEndOffset())),
        marr(offsetof(TestMessage, marr),
             neutron::zeros::AlignedOffset<uint32_t>(vec.BinaryEndOffset())),
        sarr(offsetof(TestMessage, sarr),
             neutron::zeros::AlignedOffset<uint32_t>(marr.BinaryEndOffset())),
        mvec(offsetof(TestMessage, mvec),
             neutron::zeros::AlignedOffset<uint32_t>(sarr.BinaryEndOffset())),
        svec(offsetof(TestMessage, svec),
             neutron::zeros::AlignedOffset<uint32_t>(mvec.BinaryEndOffset())),
        e(offsetof(TestMessage, e),
          neutron::zeros::AlignedOffset<uint32_t>(svec.BinaryEndOffset())),
        earr(offsetof(TestMessage, earr),
             neutron::zeros::AlignedOffset<uint32_t>(e.BinaryEndOffset())),
        evec(offsetof(TestMessage, evec),
             neutron::zeros::AlignedOffset<uint32_t>(earr.BinaryEndOffset())),
        carr(offsetof(TestMessage, carr),
             neutron::zeros::AlignedOffset<int8_t>(evec.BinaryEndOffset())),
        cvec(offsetof(TestMessage, cvec),
             neutron::zeros::AlignedOffset<uint32_t>(carr.BinaryEndOffset())) {}
  static constexpr size_t BinarySize() {
    size_t offset = 0;  // x
    offset =
        neutron::zeros::AlignedOffset<uint64_t>(offset + sizeof(uint32_t));  // y
    offset =
        neutron::zeros::AlignedOffset<uint32_t>(offset + sizeof(uint64_t));  // s
    offset = neutron::zeros::AlignedOffset<uint64_t>(offset +
                                                    sizeof(toolbelt::StringHeader));  // m
    offset = neutron::zeros::AlignedOffset<uint32_t>(
        offset + InnerMessage::BinarySize());  // arr
    offset = neutron::zeros::AlignedOffset<uint32_t>(offset + sizeof(uint32_t) *
                                                                 10);  // vec
    offset = neutron::zeros::AlignedOffset<uint32_t>(
    ...
    offset = neutron::zeros::AlignedOffset<uint32_t>(offset +
                                                    sizeof(toolbelt::VectorHeader));  // e
    offset = neutron::zeros::AlignedOffset<uint32_t>(offset +
                                                    sizeof(uint32_t));  // earr
    offset = neutron::zeros::AlignedOffset<toolbelt::VectorHeader>(
        offset + sizeof(uint16_t) * 10);  // evec

    offset = neutron::zeros::AlignedOffset<int8_t>(
        offset + sizeof(toolbelt::VectorHeader));  // carr

    offset = neutron::zeros::AlignedOffset<int8_t>(offset +
                                                  sizeof(int8_t) * 32);  // cvec

    offset = neutron::zeros::AlignedOffset<uint16_t>(
  ...
  neutron::zeros::Uint32Field x;
  neutron::zeros::Uint64Field y;
  neutron::zeros::StringField s;
  neutron::zeros::MessageField<InnerMessage> m;
  neutron::zeros::PrimitiveArrayField<int32_t, 10> arr;
  neutron::zeros::PrimitiveVectorField<int32_t> vec;
  neutron::zeros::MessageArrayField<InnerMessage, 5> marr;
  neutron::zeros::StringArrayField<20> sarr;
  neutron::zeros::MessageVectorField<InnerMessage> mvec;
  neutron::zeros::StringVectorField svec;
  neutron::zeros::EnumField<EnumTest> e;
  neutron::zeros::EnumArrayField<EnumTest, 10> earr;
  neutron::zeros::EnumVectorField<EnumTest> evec;
  neutron::zeros::PrimitiveArrayField<int8_t, 32> carr;
  neutron::zeros::PrimitiveVectorField<int8_t> cvec;
};
